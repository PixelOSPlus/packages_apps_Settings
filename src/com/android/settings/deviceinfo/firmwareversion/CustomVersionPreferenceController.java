 ...
 */
 ...
 public class CustomVersionPreferenceController extends BasePreferenceController {
     ...
     private static final String TAG = "customVersionDialogCtrl";
     private static final int DELAY_TIMER_MILLIS = 500;
     private static final int ACTIVITY_TRIGGER_COUNT = 3;
 
     private static final String KEY_CUSTOM_VERSION_PROP = "ro.custom.build.version";
     ...
     public CharSequence getSummary() {
         return SystemProperties.get(KEY_CUSTOM_VERSION_PROP,
     ...
     public void copy() {
         Sliceable.setCopyContent(mContext, getSummary(),
                 mContext.getText(R.string.custom_version));
     }
 }